			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="${pageContext.request.contextPath}/images/Emblem_of_Andhra_Pradesh.svg" class="brand_logo" alt="Logo">
					</div>
				</div>
				<div class="d-flex justify-content-center form_container">
					<form action="register" method="post">
						...
						<div class="input-group mb-3">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-lg fa-phone-volume"></i></span>
							</div>
							<input type="tel" name="phonenumber" class="form-control input_user" value="" placeholder="+91 XXXXXXXXXX">
						</div>
						<div class="input-group mb-3">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-lg fa-user"></i></span>
							</div>
							<input type="tel" name="fname" class="form-control input_user" value="" placeholder="Full name">
						</div>
